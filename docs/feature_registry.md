...
| distance_to_metro_route_km | openrouteservice Directions API, profile foot-walking | True | True | weekly snapshot / API route cache | low |
| duration_to_metro_route_min | openrouteservice Directions API, profile foot-walking | True | True | weekly snapshot / API route cache | low |
| metro_route_provider | routing metadata | True | True | weekly snapshot / API route cache | low |
